...
public class PlayerScript : MonoBehaviour
{
    ...
    public float jumpForce = 30; //30 default
    public float oldJumpForce = 30;
    public GameObject facingWall;
    public UnityEvent onDeath;
    [Header("Bonus")]
    public Toggle newJump;
    public Toggle newClimb;
    ...
    public void SetNewJumpForce(int force = 100) => jumpForce = force;
    public void SetOldJumpForce(int force = 30) => jumpForce = force;
    public void ToggleJumpForce()
    {
        switch (newJump.isOn)
        {
            case true: SetNewJumpForce(); break;
            case false: 
                SetOldJumpForce();
                SetOldWallPullForce();
                newClimb.isOn = false;
    ...
    public void SetNewWallPullForce(int force = 500) => wallPullMulti = force;
    public void SetOldWallPullForce(int force = 50) => wallPullMulti = force;
    public void ToggleWallPullForce()
    {
        switch (newClimb.isOn)
        {
            case true: 
                SetNewWallPullForce();
                SetNewJumpForce();
                newJump.isOn = true;
                break;
            case false: SetOldWallPullForce(); break;
        }
    }
    #endregion bonus features
